...
export const UserDetails = ({data}) => {
    ...
    const filterByCountry=(e)=>{
        ...
        let filterData = data.filter((elem)=>elem.location.country==e.target.value)
  ...
  return (
    <div>
        ...
        <table>
            ...
            <tbody>
            {!perpageData ? <h1>Loading...</h1> : perpageData.map((elem,index)=> <tr key={index}>
                <td><img src={elem.picture.large} alt={elem.name.first} /></td>
        ...
        <div>
            ...
            <span>{pageNo}</span>
            <button disabled={pageNo*5==data.length} onClick={()=>setPageNo(pageNo+1)}>Next</button>
        </div>
